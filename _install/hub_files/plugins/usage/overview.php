 ...
 * @copyright   Copyright 2005-2014 HUBzero Foundation, LLC.
 * @license     http://www.gnu.org/licenses/lgpl-3.0.html LGPLv3
 *
 * Copyright 2005-2014 HUBzero Foundation, LLC.
 *
...
class plgUsageOverview extends JPlugin
{
	...
	{
	   	$sql = "SELECT COUNT(datetime) FROM summary_user_vals WHERE datetime LIKE '" . mysql_real_escape_string($yearmonth) . "-%' AND period = '" . mysql_real_escape_string($period) . "'";
		$db->setQuery( $sql );
